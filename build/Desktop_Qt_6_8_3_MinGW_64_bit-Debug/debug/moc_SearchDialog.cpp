...
#include "../../../src/Frontend/Windows/SearchDialog.h"
...
static constexpr auto qt_meta_stringdata_ZN12SearchDialogE = QtMocHelpers::stringData(
    "SearchDialog",
    "onTypeChanged",
    "",
    "idx",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12SearchDialogE[] = {
...
Q_CONSTINIT const QMetaObject SearchDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12SearchDialogE.offsetsAndSizes,
    qt_meta_data_ZN12SearchDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12SearchDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *SearchDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12SearchDialogE.stringdata0))
